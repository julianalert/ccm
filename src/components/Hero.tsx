...
export function Hero() {
  return (
    <Container className="pt-8 pb-16 lg:pt-16">
      <h1 className="max-w-8xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        {' '}
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative">Cours des crypto-monnaies</span>
        </span>{' '}en temps réel
      </h1>
